// If you want to load from the installed library in node_modules:
...
client.on('qr', async (qr) => {
    ...
    if (pairingCodeEnabled && !pairingCodeRequested) {
        const pairingCode = await client.requestPairingCode('5511999158603'); // enter the target phone number
...
client.on('ready', async () => {
    ...
    const number = '5511940779540@c.us';
    const text = 'gay!';
